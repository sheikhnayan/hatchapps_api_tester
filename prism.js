...
var _self =
    ...
    Prism = (function(u) {
                ...
                highlightElement: function(e, n, t) {
                    ...
                    if (
                        (M.hooks.run("before-sanity-check", l),
                            ...
                            i.setAttribute("tabindex", "0"), !l.code)
                    )
                        return (
                            M.hooks.run("complete", l),
                                    ...
                                    for (var u = 0; u < s.length; ++u) {
                                        ...
                                        for (
                                            var p = c.pattern || c,
                                                m = a.next,
                                                y = i; m !== t.tail &&
                                            !(l && y >= l.reach); y += m.value.length, m = m.next
                                        ) {
                                            var k = m.value;
        ...
        if (
            (r &&
                ((M.filename = r.src),
                    r.hasAttribute("data-manual") && (M.manual = !0)), !M.manual)
        ) {
